...
## Milestone status
- **M1** (current): Protocol schemas + Go gateway daemon
- **M2**: Control plane (Cloudflare Workers + Durable Objects + D1)
...
- `MVP.md` is architecture source of truth; `IMPLEMENTATION_M1.md` is the M1 plan
